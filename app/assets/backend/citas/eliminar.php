...
if ($id <= 0) {
    responderJSON(false, 'Debe indicar la cita a eliminar.', null, 400);
}
...
if (!$exito) {
    ...
    if (($error['code'] ?? null) == 2292) {
        responderJSON(false, 'No se puede eliminar: la cita ya tiene una consulta médica registrada.', null, 409);
    }
